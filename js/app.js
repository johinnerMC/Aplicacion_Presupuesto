...
let cargarCabecero =  () => {
    ...
    document.getElementById('porcentaje').innerText = porcentajeEgreso;
    document.getElementById('ingresos').innerText = totalIngresos();
    document.getElementById('egresos').innerText = totalEgresos();
}
